...
comandoslist = ['comandos', 'palavra', 'palavras', 'moeda', 'paramorse', 'morsepara',
				'parabin', 'binpara', 'absurdificar', 'sair', 'alto', 'baixo']
#funçoes:
def comandos():
...
def baixo(text):
	print(text.lower())
comandosdict = {"comandos": comandos, "palavra" : palavra,"palavras": palavras,
				"moeda": moeda, "paramorse": paramorse, "morsepara":morsepara,
